package com.kobi401.browser.security.trackingProtection;
...
public class TrackingProtection {
    ...
    private void fetchTrackingUrlsFromEasyList() {
        ...
        try {
            ...
            in.close();
            Debugger.println("Successfully fetched and parsed tracking URLs from EasyList.");
        } catch (IOException e) {
            Debugger.println("Error fetching EasyList: " + e.getMessage());
        }
    }
}